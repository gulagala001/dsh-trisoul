	...
	factory: (require) => {
							...
							children: [
								...
								rounds.length ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: sortedDesc.slice(page * PAGE_SIZE, (page + 1) * PAGE_SIZE).map((r) => {
										...
										const picksText = b?.picks?.length ? b.picks.map((p) => `${p.soul ?? "?"}→${p.reject ? t("souls.vote.reject.short") : p.pick ?? t("souls.vote.abstain.short")}${p.via === "tool" ? "!" : ""}`).join(" · ") : "";
										...
										cards.map(({ id, tone }) => {
											...
											return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", {
												...
												children: [
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
														className: MonitorPanel_module_css_default.tdRoute,
														children: [`${s?.provider ?? route?.provider ?? soul?.provider ?? "—"} / ${s?.model ?? route?.model ?? soul?.model ?? "—"}${route?.temperature !== void 0 ? ` · T=${route.temperature}` : ""}${route?.reasoningEffort ? ` · ${route.reasoningEffort}` : ""}`, isCanvas && s?.regionChars ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
															className: MonitorPanel_module_css_default.tdCounts,
															children: [" · ", t("comp.canvas.compaction", {
																region: fmtNum(s.regionChars),
																surface: fmtNum(s.surfaceTotal ?? 0)
															})]
														}) : null]
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
									...
									children: [
										...
										laneIds.map((id, li) => perStep[ci].filter((e) => e.id === id).map((e, ei) => {
											...
											const pickLabel = pick ? (pick.reject ? "✗" : pick.pick === null || pick.pick === void 0 ? "∅" : `→${pick.pick}`) + (pick.via === "tool" ? "!" : "") : null;
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									e.via === "tool" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: MonitorPanel_module_css_default.voteReason,
										children: t("souls.vote.viaTool")
									}) : null,
		...
		*/
		...
		const zh = {
			...
			"comp.canvas.compaction": "手术区间 {region} 字 · 表面 {surface} 字",
			...
			"souls.vote.viaTool": "工具票（面板已撤空，不该出现——查该渠道的格式锁）",
			"souls.vote.raw": "原始输出",
		...
		const en = {
			...
			"comp.canvas.compaction": "region {region} chars · surface {surface} chars",
			...
			"souls.vote.viaTool": "tool ballot (panel is empty — should not happen; check this channel's format lock)",
