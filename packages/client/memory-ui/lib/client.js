window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:packages/client/memory-ui/src/client/MemoryScopeChip.module.css.mjs
